...
public class Toast {
    ...
    public Toast(String text, Length length, BitmapFont font, Color backgroundColor, float fadingDuration, float maxRelativeWidth, Color fontColor, float positionY, Integer customMargin) {
        this.msg = text;
        this.font = font;
    ...
    public static class ToastFactory {
        ...
        public Toast create(String text, Length length) {
            return new Toast(text, length, font, backgroundColor, fadingDuration, maxRelativeWidth, fontColor, positionY, customMargin);
        }
